...
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Agregar Robot') }}</div>
                <div class="card-body">
                    <form method="POST" action="{{route('arduino.create')}}">
                        @csrf
                        <div class="form-group row">
                            <label for="nro_serie" class="col-md-4 col-form-label text-md-right">{{ __('Número de serie') }}</label>

                            <div class="col-md-6">
                                <input id="nro_serie" type="text" class="form-control{{ $errors->has('nro_serie') ? ' is-invalid' : '' }}" name="nro_serie" value="{{ old('nro_serie') }}" required autofocus>
