    ...
    <div class="row mt-3 mb-2">
      <div class="col-sm-12">
          <button id="for-grupo" value="0" class="btn btn-success"> INICIAR FOR </button>
            ...
            &nbsp; &nbsp;
            <button id="compara" value="0" class="btn btn-primary"> IF </button>
                        &nbsp; &nbsp;
                        <div id="compara-ocultar" class="horizontal">
                        <select name="comparador" id="comparador" class="pasos">
                        ...
                        &nbsp; &nbsp;
                        <select name="limite" id="limite" class="pasos">
                            <option value="_" selected>_</option>
                        ...
                        &nbsp; &nbsp;
                        <b>&nbsp; &nbsp; Salto instrucción: &nbsp; &nbsp;</b><select name="salto" id="salto" class="pasos">
                            <option value="_" selected>_</option>
                            <option value="1">1</option>
                            <option value="2">2</option>
                            <option value="3">3</option>
                        ...
                        &nbsp; &nbsp;
                        <small>Recuerde cerrar el if</small>
                        &nbsp; &nbsp;
      </div>
        <div class="col-sm-12">
                        </div>
